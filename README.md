...
**Free2Party** is a social Android application designed to help friends coordinate their availability and manage events in real-time, simplifying the logistics of group gatherings. Whether you're looking for someone to grab a coffee with or planning a night out, Free2Party lets you see who is "Free" at a glance, and create events and invite friends. This project serves as a showcase of how to build a scalable, user-centric product from ideation to a production-ready state.
...
- **Event Coordination & RSVP**:
  - Create events with specific titles, descriptions, times, and locations.
  - Invite friends or whole circles to your events.
  - Real-time RSVP tracking (Going, Not Going).
  - Shared event comments section for quick coordination and logistics.
- **Adaptive Layouts**:
...
- [x] Phase 6: Events (RSVP System)
  - [x] Create an event (e.g., "Beer at 7pm @ The Local Pub").
  - [x] Friends can RSVP "Going" or "Not Going" directly in the app.
  - [x] Shared event comments section for quick logistics.
